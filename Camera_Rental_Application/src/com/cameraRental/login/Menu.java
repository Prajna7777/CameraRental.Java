...
import com.cameraRental.Camera;
import com.cameraRental.CameraDetails;
import com.cameraRental.MyWallet;
...
public class Menu {
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 5:
                    ...
                    break;
                default:
                    System.out.println("You entered the wrong choice. Please enter the correct option");
                    break;
            }
        }
    }
        ...
        while (true) {
            ...
            switch (ch2) {
                ...
                case 4:
                    return;
                default:
                    System.out.println("You entered the wrong choice. Please enter the correct choice");
                    break;
            }
        }
    }
    ...
    public void removeCamera() {
        showCameras();
        System.out.print("Enter camera id which you want to remove: ");
    ...
    public void showCameras() {
        ...
        if (cameraC.isEmpty()) {
            ...
            for (int i = 0; i < cameraC.size(); i++) {
                ...
                System.out.printf("%-10s %-20s %-20s %-20s %-10s%n", i + 1, camera.getBrand(), camera.getModel(),
    ...
    public void myWallet() {
        ...
        System.out.print("Do you want to deposit more money (1.Yes/2.No): ");
